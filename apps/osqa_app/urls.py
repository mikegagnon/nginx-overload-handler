...
#
# This file is essentially fantasy-island-0.9.0-beta3/forum/urls.py
# but incorporates the bug fix specified in http://stackoverflow.com/questions/5503616/how-to-correct-this-error-adminsite-object-has-no-attribute-root
